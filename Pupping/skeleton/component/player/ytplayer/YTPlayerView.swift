...
//    }
    ...
    public func playVideo(){
        self.stringFromEvaluatingJavaScript(jsToExecute: "player.playVideo();")
    }
    ...
    public func pauseVideo(){
        ...
        self.stringFromEvaluatingJavaScript(jsToExecute: "player.pauseVideo();")
    }
    ...
    public func stopVideo(){
        self.stringFromEvaluatingJavaScript(jsToExecute: "player.stopVideo();")
    }
    ...
    public func seek(seekToSeconds: Float, allowSeekAhead: Bool){
        ...
        self.stringFromEvaluatingJavaScript(jsToExecute: command)
    }
    ...
    public func setPlaybackRate(_ rate:Float){
        let command = String(format: "player.setPlaybackRate(%f);", rate)
        self.stringFromEvaluatingJavaScript(jsToExecute: command)
    }
    public func getPlaybackRate(resultHandler:@escaping (Float) -> Void){
        self.stringFromEvaluatingJavaScript(jsToExecute: "player.getPlaybackRate();"){ v in
            let rate = v as? Float ?? 1.0
            resultHandler(rate)
        }
    }
     ...
     */
    public func getAvailablePlaybackRates(resultHandler:@escaping ([Float]?) -> Void){
        self.stringFromEvaluatingJavaScript(jsToExecute: "player.getAvailablePlaybackRates();"){ v in
            do {
                let returnValue = v as? String ?? ""
                ...
                resultHandler( playbackRates as? [Float] )
            } catch  {
                resultHandler(nil)
            }
        }
     ...
     *         already loaded.
     */
     public func getVideoLoadedFraction(resultHandler:@escaping (Float) -> Void){
        self.stringFromEvaluatingJavaScript(jsToExecute: "player.getVideoLoadedFraction();"){ v in
            let returnValue = v as? Float ?? 0
     ...
     */
      public func getPlayerState(resultHandler:@escaping (YTPlayerState) -> Void){
            self.stringFromEvaluatingJavaScript(jsToExecute: "player.getPlayerState();"){ v in
                guard let state = YTPlayerState(rawValue:v as? String ?? "") else{
                    resultHandler( .unknown)
                    return
                }
                resultHandler( state)
            }
     ...
     */
    public func getCurrentTime(resultHandler:@escaping (Float) -> Void){
        self.stringFromEvaluatingJavaScript(jsToExecute: "player.getCurrentTime();"){ v in
            let returnValue = v as? Float ?? 0
            resultHandler(returnValue)
        }
    }
     ...
     */
    public func setPlaybackQuality(_ quality:YTPlaybackQuality){
        let command = String(format: "player.setPlaybackQuality('%@');", quality.rawValue)
        self.stringFromEvaluatingJavaScript(jsToExecute: command)
    }
    public func getPlaybackQuality(resultHandler:@escaping (YTPlaybackQuality) -> Void){
        self.stringFromEvaluatingJavaScript(jsToExecute: "player.getPlaybackQuality();"){ v in
            guard let quality = YTPlaybackQuality(rawValue:v as? String ?? "" ) else{
               resultHandler(.unknown)
               return
            }
            resultHandler(quality)
        }
    }
    ...
    public func getAvailableQualityLevels(resultHandler:@escaping ([YTPlaybackQuality]?) -> Void){
       self.stringFromEvaluatingJavaScript(jsToExecute: "player.getAvailableQualityLevels().toString();"){ v in
            let value = v as? String ?? ""
            if value.isEmpty { resultHandler(nil) }
     ...
     */
    public func getDuration(resultHandler:@escaping (TimeInterval) -> Void){
        self.stringFromEvaluatingJavaScript(jsToExecute: "player.getDuration();"){ v in
            let returnValue = v as? Double ?? 0
            resultHandler(returnValue)
        }
    }
     ...
     */
    public func getVideoUrl(resultHandler:@escaping (URL?) -> Void){
        self.stringFromEvaluatingJavaScript(jsToExecute: "player.getVideoUrl();"){ v in
            let returnValue = v as? String ?? ""
            guard let url = URL(string: returnValue) else{
                resultHandler(nil)
                return
            }
            resultHandler( url )
     ...
     */
    public func getVideoEmbedCode(resultHandler:@escaping (String) -> Void){
        self.stringFromEvaluatingJavaScript(jsToExecute: "player.getVideoEmbedCode();"){ v in
            let returnValue = v as? String ?? ""
            resultHandler( returnValue )
        }
    }
     ...
     */
    public func getPlaylist(resultHandler:@escaping ([String]?) -> Void){
       self.stringFromEvaluatingJavaScript(jsToExecute: "player.getPlaylist();"){ v in
            let returnValue = v as? String ?? ""
            do {
                ...
                resultHandler( videoIds as? [String] )
            } catch  {
                resultHandler( nil )
            }
       }
     ...
     */
    public func getPlaylistIndex(resultHandler:@escaping (Int) -> Void){
        self.stringFromEvaluatingJavaScript(jsToExecute: "player.getPlaylistIndex();"){ v in
            let returnValue = v as? Int ?? 0
            resultHandler( returnValue )
        }
    }
     ...
     */
    private func stringFromEvaluatingJavaScript(jsToExecute: String){
        self.webView.evaluateJavaScript(jsToExecute)
    }
    private func stringFromEvaluatingJavaScript(jsToExecute: String, resultHandler:@escaping (Any?) -> Void){
    ...
    private func loadWithPlayerParams(additionalPlayerParams:[String: Any]? = nil) -> Bool{
        ...
        self.stringFromEvaluatingJavaScript(jsToExecute: scriptContent)
...
extension YTPlayerView: WKNavigationDelegate, WKUIDelegate,  WKScriptMessageHandler{
    ...
    public func webView(_ webView: WKWebView, decidePolicyFor navigationAction: WKNavigationAction, decisionHandler: @escaping (WKNavigationActionPolicy) -> Void) {
        ...
        if url.host == self.originURL.host{
            ...
            self.handleHttpNavigationToUrl(url: url) ? decisionHandler(.allow) : decisionHandler(.cancel)
            return
        }
        decisionHandler(.allow)
    }
